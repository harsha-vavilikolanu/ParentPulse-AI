...
const Navbar = () => {
  const { toggleSidebar, user, studentData, logout } = useStore();
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-8 h-8 rounded-full bg-primary flex items-center justify-center text-white font-bold text-sm">
            <img src="/src/assets/vignanlogo.png" alt="Vignan Logo" className="w-8 h-8 rounded-full object-cover" />
          </div>
        ...
        {user && studentData && (
          ...
          <>
            ...
            <div className="hidden md:flex flex-col items-end mr-2">
              <span className="text-sm font-semibold text-slate-800">{studentData.name}</span>
              <span className="text-xs text-slate-500">{studentData.regNo}</span>
            </div>
            <button 
